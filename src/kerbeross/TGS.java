...
public class TGS {
    ...
    public static void main(String[] args) throws IllegalBlockSizeException, UnknownHostException, IOException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        byte[] message_3_Bytes = comunicator.getBytes(ipC, AUTH_PORT);
        String message_3 = new String(message_3_Bytes, StandardCharsets.UTF_8);
        ...
        byte[] E_K_TGS_Ticket_TGS_Bytes = E_K_TGS_Ticket_TGS.getBytes();
        ...
        String ticket_V = ticket_V_Array.toString();
        ...
        String message_4 = message_4_Array.toString();
